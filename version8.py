...
# ADDED IN VERSION 7: Refreshes the workout screen dropdown then opens the screen.
...
# ADDED IN VERSION 7: OptionMenu dropdown populated from past exercises at screen open time.
